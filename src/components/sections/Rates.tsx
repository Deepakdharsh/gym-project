...
const pricingData: PricingTier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Free protein shake every visit",
...
const Rates: React.FC = () => {
  ...
  return (
    <section id="rates" className="bg-white py-16 md:py-24 lg:py-[100px] overflow-hidden">
      <div className="container">
        ...
        >
          ...
          <h2 className="text-black text-[32px] md:text-[40px] lg:text-[48px] font-bold uppercase tracking-tight leading-[0.9]">
            Membership Rates
          </h2>
          <motion.div
            initial={{ scaleX: 0 }}
            ...
            className="w-full h-px bg-black mt-6 md:mt-8 origin-left"
          ></motion.div>
        </motion.div>
              ...
              <ul className="flex-grow space-y-4 mb-12">
                {tier.features.map((feature, fIndex) => (
                  <li key={fIndex} className="flex items-start text-sm md:text-base leading-relaxed">
                    <span className="mr-3 mt-1.5 w-1.5 h-1.5 bg-[#E4480B]  flex-shrink-0"></span>
              ...
              <div className="mt-auto">
                {index === 1 ? (
                  ...
                  <motion.a
                    ...
                    whileTap={{ scale: 0.98 }}
                    href="#"
                    className="flex items-center justify-center bg-[#E4480B] text-white w-full text-center py-4  font-bold uppercase tracking-wider transition-opacity duration-300 hover:opacity-90"
                  >
                    {tier.ctaText}
                  </motion.a>
                ) : (
                  ...
                  <motion.a
                    ...
                    whileTap={{ scale: 0.98 }}
                    href="#"
                    className="inline-flex items-center justify-center w-full py-4 border-2 border-black  font-bold uppercase text-sm tracking-widest transition-all duration-300"
                  >
                    {tier.ctaText}
                  </motion.a>
                )}
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-100px" }}
          variants={fadeInUp}
          className="mt-20 md:mt-32 p-8 md:p-12 bg-[#F5F5F5]  md: flex flex-col md:row items-center justify-between gap-8 border border-transparent hover:border-black transition-all duration-500"
        >
